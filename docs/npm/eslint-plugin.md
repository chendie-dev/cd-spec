...
```shell
$ npm install cd-eslint-plugin eslint --save-dev
```
...
// .eslintrc.js
module.exports = {
  plugin: ['cd-eslint-config'],
  rules: {
    'cd-eslint-plugin/no-secret-info': 'error',
  },
};
```
...
// .eslintrc.js
module.exports = {
  extends: 'plugin:cd-eslint-plugin/recommended',
};
```
...
```js
var test = 'http://cd.com';
var jsx = <img src="http://cd.com">;
```
